...
import { calculateTotals, formatMoney, formatDateString } from "../../utils/calculations";

export default function ClassicTemplate({ invoiceData, t, elementRef, onPayClick, lang }) {
  const {
    title,
    logo,
    invoiceNumber,
  ...
  return (
    <div
      className={`invoice-a4-sheet${paperTexture ? " paper-crumpled" : ""}`}
      ref={elementRef}
